...
<div class="kc-root">
	<div class="kc-container">
		...
		<nav style="padding: 40px 0; font-size: 11px; font-weight: 850; letter-spacing: 0.1em; color: var(--k-text-muted);">
			...
			<a href="/lists" style="color: inherit; text-decoration: none;">EXPLORE</a> &nbsp; / &nbsp; 
		...
		<section style="display:flex; gap:12px; flex-wrap:wrap; margin: 0 0 28px;">
			<a href="<?php echo esc_url( 'https://twitter.com/intent/tweet?text=' . rawurlencode( $item_share_caption ) . '&url=' . rawurlencode( $item_share_url ) ); ?>" target="_blank" rel="noopener" class="kc-btn-dashboard" style="text-decoration:none;">Share Track</a>
			<button type="button" class="kc-btn-dashboard" data-share-copy="<?php echo esc_attr( $item_share_caption ); ?>" data-share-label="Copy Caption" style="background:rgba(255,255,255,0.08);">Copy Caption</button>
		</section>
		...
		<div class="kc-item-grid-split">
				...
				<div class="kc-bento-stats">
					...
					<div class="kc-stat-card">
						...
						<div class="val" style="font-size: 1rem; text-transform:uppercase; letter-spacing:0.1em; color:<?php echo $intel && $intel->trend_status === 'rising' ? 'var(--k-accent-green)' : ($intel && $intel->trend_status === 'falling' ? 'var(--k-accent-red)' : 'inherit'); ?>;">
							<?php echo $intel ? ($intel->trend_type ?: $intel->trend_status) : 'Stable'; ?>
						</div>
					</div>
					<div class="kc-stat-card">
			...
			<div class="kc-col-appearances">
				<h3 style="font-size: 11px; font-weight: 900; letter-spacing: 0.15em; margin-bottom: 32px; color: var(--k-text-dim);">LIST APPEARANCES</h3>
						...
						<div class="kc-appearance-card">
							<div class="kc-app-info">
								...
								<div class="kc-app-details">
									<h4><?php echo esc_html($h->chart_title ?: 'Featured List'); ?></h4>
