	...
	<div class="kc-container">
		<div class="kc-micro-inner">
			<div class="micro-left">
				KONTENTAINMENT LISTS &middot; WEEK OF <?php echo strtoupper($week_date); ?>
			</div>
			...
			<div style="display: flex; align-items: center; gap: 60px;">
				...
				<nav class="charts-nav">
					<ul class="charts-menu">
						<li class="current-menu-item"><a href="/lists">Home</a></li>
						<li><a href="/lists">Lists</a></li>
						<li><a href="/lists/trending">Trending</a></li>
						<li><a href="/lists">Tracks</a></li>
						<li><a href="/lists">Artists</a></li>
						<li><a href="/lists">Albums</a></li>
					</ul>
				</nav>
				<?php endif; ?>
			</div>
