...
<div class="kc-root">
	...
	<section class="kc-container">
		...
		<nav style="padding: 20px 0 40px; font-size: 11px; font-weight: 850; letter-spacing: 0.1em; color: var(--k-text-muted);">
			...
			<a href="/lists" style="color: inherit; text-decoration: none;">TOP ARTIST LISTS</a> &nbsp; / &nbsp; 
		...
		<section style="display:flex; gap:12px; flex-wrap:wrap; margin: 0 0 28px;">
			<a href="<?php echo esc_url( 'https://twitter.com/intent/tweet?text=' . rawurlencode( $artist_share_caption ) . '&url=' . rawurlencode( $artist_share_url ) ); ?>" target="_blank" rel="noopener" class="kc-btn-dashboard" style="text-decoration:none;">Share Artist</a>
			<button type="button" class="kc-btn-dashboard" data-share-copy="<?php echo esc_attr( $artist_share_caption ); ?>" data-share-label="Copy Caption" style="background:rgba(255,255,255,0.08);">Copy Caption</button>
		</section>
		...
		<div class="kc-artist-split">
			...
			<div class="kc-col-left">
				<section class="kc-charting-section" style="margin-bottom: 60px;">
					<h3 class="kc-col-title">LISTING TRACKS</h3>
						...
						<div class="kc-appearance-card">
							<div class="kc-app-info">
								...
								<div class="kc-app-details">
									...
									<span style="font-size: 10px;"><?php echo esc_html($ct->chart_title ?: 'Featured List'); ?></span>
								</div>
							</div>
			...
			<div class="kc-col-right">
				<section class="kc-rankings-section" style="margin-bottom: 60px;">
					<h3 class="kc-col-title">LIST RANKINGS</h3>
						...
						<?php foreach ($artist_rankings as $ar) : ?>
							<div class="kc-appearance-card">
								<div class="kc-app-info">
									<img src="<?php echo esc_url($hero_img); ?>" class="kc-app-art" style="border-radius: 50%;">
									<div class="kc-app-details">
										<h4><?php echo esc_html($ar->chart_title ?: 'Major List'); ?></h4>
									</div>
								</div>
								<div class="kc-app-rank-box" style="flex-direction: column; align-items: flex-end; gap: 4px;">
		...
		<section class="kc-more-charts" style="margin-top: 80px;">
			<header class="kc-section-header">
				<div>
					...
					<h2 class="kc-header-title">More Lists</h2>
				</div>
				<a href="/lists" class="kc-header-link" style="color: var(--k-text-muted);">View All Lists &rarr;</a>
			</header>
					...
					<article class="kc-chart-card">
						<div class="kc-card-hero" style="height: 120px;">
							<div style="position: relative; z-index: 10;">
								<span class="kc-card-meta"><?php echo strtoupper($m_def->frequency); ?> LIST</span>
						...
						<div class="kc-card-footer">
							...
							<a href="<?php echo home_url('/lists/' . $m_def->slug); ?>" class="kc-card-cta" style="color: var(--k-accent);">See Full List &rarr;</a>
						</div>
					</article>
				<?php endforeach; ?>
			</div>
