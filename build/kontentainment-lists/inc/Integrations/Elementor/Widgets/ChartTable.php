...
/**
 * Elementor Widget: List Table
 */
class ChartTable extends Widget_Base {

	public function get_name() { return 'charts_table'; }
	public function get_title() { return __( 'Intelligence Table', 'kontentainment-lists' ); }
	public function get_icon() { return 'eicon-table'; }
	public function get_categories() { return [ 'kontentainment-lists' ]; }

	protected function register_controls() {
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Intelligence Config', 'kontentainment-lists' ) ] );
		...
		$this->add_control( 'limit', [
			'label' => __( 'No. of Items', 'kontentainment-lists' ),
