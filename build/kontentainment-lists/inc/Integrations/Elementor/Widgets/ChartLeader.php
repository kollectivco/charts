...
/**
 * Elementor Widget: List Leader Hero
 */
class ChartLeader extends Widget_Base {

	public function get_name() { return 'chart_leader'; }
	public function get_title() { return __( 'List Leader Hero', 'kontentainment-lists' ); }
	public function get_icon() { return 'eicon-info-box'; }
	public function get_categories() { return [ 'kontentainment-lists' ]; }

	protected function register_controls() {
		$this->start_controls_section( 'section_content', [ 'label' => __( 'Hero Config', 'kontentainment-lists' ) ] );
					...
					<div class="hero-info" style="padding: 48px 48px 48px 0;">
						...
						<div class="kc-stats-bar" style="margin-top: 0; gap: 48px;">
							<div class="kc-stat-item">
								<span class="kc-stat-lbl">WEEKS ON LIST</span>
						...
						<div style="margin-top: 48px;">
							<a href="<?php echo home_url('/lists/' . $def->slug . '/'); ?>" class="kc-btn large">
								<?php _e( 'Explore Market Intelligence', 'kontentainment-lists' ); ?> &rarr;
							</a>
						</div>
					</div>
				</div>
