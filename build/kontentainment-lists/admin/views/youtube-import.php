...
<div class="wrap charts-admin-wrap">
	<h1><?php esc_html_e( 'YouTube CSV Import', 'kontentainment-lists' ); ?></h1>
	...
	?>
		<div class="notice notice-warning is-dismissible" style="margin: 20px 0; border-left: 4px solid #f59e0b; background: #fffbeb;">
			<p>
				<strong><?php esc_html_e( 'Notice: Metadata Enrichment Disabled', 'kontentainment-lists' ); ?></strong><br>
				<?php printf( 
					__( 'You have not configured a YouTube API Key. While the import will still work using the CSV data, the system cannot fetch official titles, channel names, or high-quality artwork via the YouTube API. <a href="%s">Configure YouTube API Key &rarr;</a>', 'kontentainment-lists' ),
		...
		<form method="post" action="" enctype="multipart/form-data">
			...
			<div class="import-form-grid">
				<section class="file-upload-section">
					<h2>1. <?php esc_html_e( 'Select CSV File', 'kontentainment-lists' ); ?></h2>
					<p class="description"><?php esc_html_e( 'Upload your YouTube chart CSV. Any column layout is supported — headers are mapped automatically.', 'kontentainment-lists' ); ?></p>
					...
					<div class="help-box" style="background: #f9f9f9; padding: 15px; border-left: 4px solid #FF0000; border-radius: 4px; font-size: 12px;">
						<strong><?php esc_html_e( 'Recognized Column Aliases:', 'kontentainment-lists' ); ?></strong>
				...
				<section class="meta-section">
					<h2>2. <?php esc_html_e( 'Import Options', 'kontentainment-lists' ); ?></h2>
					...
					<table class="form-table">
						...
						<tr>
							<th scope="row"><label for="yt_chart_type">List Type</label></th>
							<td>
						...
						<tr>
							<th scope="row"><label for="yt_period_date">List Date</label></th>
							<td>
								<input type="date" name="period_date" id="yt_period_date" value="<?php echo date('Y-m-d'); ?>" required>
								<p class="description">For weekly lists, select the week's start or end date — the system aligns to Monday automatically.</p>
							</td>
						</tr>
						<tr>
			...
			<div class="submit-footer" style="padding-top: 20px; border-top: 1px solid #eee; margin-top: 30px;">
				<button type="submit" class="button button-primary button-large"><?php esc_html_e( 'Import YouTube CSV', 'kontentainment-lists' ); ?></button>
			</div>
		</form>
	</div><!-- .charts-card -->
</div><!-- .wrap -->
