...
<div class="wrap charts-admin-wrap">
	<h1><?php esc_html_e( 'Spotify CSV Import', 'kontentainment-lists' ); ?></h1>
		...
		<form method="post" action="" enctype="multipart/form-data">
			...
			<div class="import-form-grid">
				<section class="file-upload-section">
					...
					<p class="description"><?php esc_html_e( 'Upload the official Spotify chart export CSV.', 'kontentainment-lists' ); ?></p>
					...
					<div class="help-box" style="background: #f9f9f9; padding: 15px; border-left: 4px solid #3366ff; border-radius: 4px;">
						<strong><?php esc_html_e( 'Expected Columns:', 'kontentainment-lists' ); ?></strong>
				...
				<section class="meta-section">
					...
					<table class="form-table">
						...
						<tr>
							<th scope="row"><label for="chart_type">List Type</label></th>
							<td>
						...
						<tr>
							<th scope="row"><label for="period_date">List Date</label></th>
							<td>
								<input type="date" name="period_date" id="period_date" value="<?php echo date('Y-m-d'); ?>" required>
								<p class="description">For weekly lists, please select the end date of the week.</p>
							</td>
						</tr>
						<tr>
			...
			<div class="submit-footer" style="padding-top: 20px; border-top: 1px solid #eee; margin-top: 30px;">
				<button type="submit" class="button button-primary button-large"><?php esc_html_e( 'Import and Enrich', 'kontentainment-lists' ); ?></button>
			</div>
		</form>
	</div>
</div>
