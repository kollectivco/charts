...
<aside class="kc-db-sidebar">
	...
	<nav class="kc-db-nav">
		...
		<a href="<?php echo home_url('/charts-dashboard/entities'); ?>" class="kc-db-nav-item <?php echo in_array($current_module, ['entities','artists','tracks','videos']) ? 'active' : ''; ?>">
		...
		<a href="<?php echo home_url('/charts-dashboard/forecast'); ?>" class="kc-db-nav-item <?php echo $current_module === 'forecast' ? 'active' : ''; ?>">
