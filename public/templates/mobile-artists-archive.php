...
<body <?php body_class('kc-body-mobile cm-view-artists-archive'); ?>>
                        ...
                        <div class="cm-details-wrapper">
                            <div class="cm-details-inner">
                                ...
                                <div class="cm-detail-cta" style="grid-column: span 2; padding-top: 12px; border-top: 1px solid var(--cm-divider); margin-top: 4px;">
                                    <a href="<?php echo add_query_arg('mobile_view', '1', home_url('/charts/artist/' . $a->slug . '/')); ?>" style="display: flex; align-items: center; justify-content: space-between; font-size: 12px; font-weight: 800; color: var(--cm-primary); text-transform: uppercase; letter-spacing: 0.05em;">
