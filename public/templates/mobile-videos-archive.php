...
<body <?php body_class('kc-body-mobile cm-view-videos-archive'); ?>>
...
<div class="cm-app-shell">
    ...
    <main class="cm-content">
        <div class="cm-charts-list" style="padding: 10px 0;">
            <?php if ( empty($videos) ) : ?>
                <div style="padding: 40px; text-align: center; color: var(--cm-text-muted);">No videos found.</div>
            <?php else : ?>
                    ...
                    <div class="cm-row-item kc-rank-row">
                        <div class="cm-row" style="padding: 14px 20px;">
                            ...
                            <div class="cm-row-info">
                                <span class="cm-row-title"><?php echo esc_html($v->title); ?></span>
                                <span class="cm-row-sub"><?php echo esc_html($v->artist_name); ?></span>
                            </div>
                        ...
                        <div class="cm-details-wrapper">
                            <div class="cm-details-inner">
                                ...
                                <div class="cm-detail-cta" style="grid-column: span 2; padding-top: 12px; border-top: 1px solid var(--cm-divider); margin-top: 4px;">
                                    <a href="<?php echo add_query_arg('mobile_view', '1', home_url('/charts/video/' . $v->slug . '/')); ?>" style="display: flex; align-items: center; justify-content: space-between; font-size: 12px; font-weight: 800; color: var(--cm-primary); text-transform: uppercase; letter-spacing: 0.05em;">
