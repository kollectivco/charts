<?php
/**
 * CM Mobile Experience: Track Archive
 */
...
?>
<!DOCTYPE html>
<!-- CM_RENDERER: public/templates/cm-tracks-archive.php -->
<html <?php language_attributes(); ?>>
<head>
    <meta charset="<?php bloginfo( 'charset' ); ?>">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover">
    <title>Top Tracks — CM</title>
...
<body <?php body_class('cm-body-mobile cm-view-tracks-archive'); ?>>
                        ...
                        <div class="cm-details-wrapper">
                            <div class="cm-details-inner">
                                ...
                                <div class="cm-detail-cta" style="grid-column: span 2; padding-top: 12px; border-top: 1px solid var(--cm-divider); margin-top: 4px;">
                                    <a href="<?php echo home_url('/cm/track/' . $t->slug . '/'); ?>" style="display: flex; align-items: center; justify-content: space-between; font-size: 12px; font-weight: 800; color: var(--cm-primary); text-transform: uppercase; letter-spacing: 0.05em;">
