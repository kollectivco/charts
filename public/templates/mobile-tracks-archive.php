...
<body <?php body_class('kc-mode-mobile kc-view-tracks-archive'); ?>>
                    ...
                    <div class="kc-row-item kc-rank-row">
                        <div class="kc-row" style="padding: 14px 20px;">
                            ...
                            <div class="kc-row-info">
                                <span class="kc-row-title"><?php echo esc_html($t->title); ?></span>
                                <span class="kc-row-sub"><?php echo esc_html($t->artist_name); ?></span>
                            </div>
