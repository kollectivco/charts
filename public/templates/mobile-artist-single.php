<?php
/**
 * Mobile Mode: Artist Profile View
 */
...
<body <?php body_class('kc-body-mobile cm-view-artist-single'); ?>>
    ...
    <main class="cm-content">
        ...
        <section class="cm-section" style="padding: 0 20px 40px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 8px;">
                ...
                ?>
                    <a href="<?php echo esc_url($pt_url); ?>" class="cm-row" style="padding: 12px 16px; background:var(-kc-surface); border-radius:12px; border:1px solid var(-kc-divider); text-decoration:none;">
